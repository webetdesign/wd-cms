...
abstract class AbstractBlock implements BlockInterface
{
    ...
    public function render($value, ?array $context = null)
    {
        ...
        return $this->replaceVarsIn($value);
    }

    public function replaceVarsIn($value)
    {
        if (is_string($value) && $this->getConfiguration()->getVarsBag()) {
            $value = $this->getConfiguration()->getVarsBag()->replaceIn($value);
        }
    ...
    {
        return $this->configuration->getBlockRegistry();
    }
     ...
     * @return AbstractBlock
     */
    public function setConfiguration(ConfigurationInterface $configuration): AbstractBlock
    {
